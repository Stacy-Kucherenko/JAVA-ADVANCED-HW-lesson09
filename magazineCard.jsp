...
<head>
    ...
    <title>Интернет-магазин журналов - Журнал "${magazine.title}"</title>
</head>
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Дата публикации: <br>
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#buyMagazineModal">Купить</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Покупка журнала "${magazine.title}"</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            Вы действительно хотите добавить журнал "${magazine.title}" в корзину?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
                            <button type="button" magazineID="${magazine.id}" class="btn btn-primary buy-magazine">Купить</button>
                        </div>
                    </div>
                </div>
            </div>
